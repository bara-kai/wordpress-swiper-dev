...
const spring = (fromValue, toValue, update) => new Promise((r) => new wobble.Spring(Object.assign(Object.assign({}, defaultSpringConfig), { fromValue, toValue }))
...
const scrollIntoView = (target, options) => {
    ...
    return Promise.all(computeScrollIntoView__default['default'](target, opts).map(({ el, top, left }) => doScroll(el, left, top, opts.behavior))).then(() => { });
};
